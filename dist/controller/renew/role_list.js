    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          pool = _context.sent;
          _context.next = 7;
          return pool.request().query('SELECT F_ID,F_NAME,q.F_QUEUE_ID FROM t_role as r	LEFT JOIN (SELECT F_ROLE_ID,F_QUEUE_ID FROM t_qrole) as q ON q.F_ROLE_ID = r.F_ID');
        ...
        case 24:
          ...
          _context.next = 30;
          return connect.query('SELECT F_ID,F_NAME,q.F_QUEUE_ID FROM t_role as r	LEFT JOIN (SELECT F_ROLE_ID,F_QUEUE_ID FROM t_qrole) as q ON q.F_ROLE_ID = r.F_ID');
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _connectionScenterDB.default.query('UPDATE role SET ' + 'F_NAME="' + (0, _additionalFunction.htmlspecialchars)(data.F_NAME) + '", ' + 'F_QUEUE_ID="' + (0, _additionalFunction.nulltozero)(data.F_QUEUE_ID) + '" ' + 'WHERE F_ID=' + data.F_ID + ' ');
          ...
          case 2:
            ...
            _context2.next = 6;
            return _connectionScenterDB.default.query('INSERT INTO role SET ' + 'F_ID="' + data.F_ID + '", ' + 'F_NAME="' + (0, _additionalFunction.htmlspecialchars)(data.F_NAME) + '", ' + 'F_QUEUE_ID="' + (0, _additionalFunction.nulltozero)(data.F_QUEUE_ID) + '" ');
